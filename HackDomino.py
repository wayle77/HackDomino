...
class Main:
	def __init__(self):
		...
		os.system("clear")
		print(logo)
		print('\033[93;1mwww.HiggsDomino.com\033[0m')
		print('\033[1;92mwww.NeptuneDomino.com\033[0m')
		print("")
	...
	def fbtua(self):
		...
		limit = int(input("\033[97;1m[➤] HACK AKUN ID MAX 300,000: "))
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				print("%s[➤] GUNAKAN ID AKUN INI [➤] %s456789,123456,1234567,123456789"%(G,Y))
				listpass = input("%s[➤] MASUKAN ID AKUN :%s "%(G,Y))
				if len(listpass)<=5:
					exit("\n%s[➤] SANDI MAX 6 "%(B))
				print("%s[➤] CRACK MENGGUNAKAN SANDI -> [\033[0;91m%s\033[0;93m]"%(G,listpass))
				print("\n%s[➤] ID AKUN DISIMPAN DI -> SDcard.txt"%(G))
